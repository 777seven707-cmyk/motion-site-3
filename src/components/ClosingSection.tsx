...
export default function ClosingSection() {
  return (
    <section
      id="cta"
      className="relative z-20 bg-black px-5 md:px-[35px] py-[100px] md:py-[160px] border-t border-white/10 flex items-center justify-center text-center"
    >
      <Reveal className="max-w-[680px]">
        ...
        <a
          ...
          className="bg-[#AFDDFF] px-[20px] py-[12px] inline-flex items-center gap-[10px] hover:bg-[#c8e8ff] transition-colors mt-[36px]"
        >
